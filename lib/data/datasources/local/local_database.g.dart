...
class $WorkEntriesTableTable extends WorkEntriesTable
    with TableInfo<$WorkEntriesTableTable, WorkEntriesTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $WorkEntriesTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'work_entries_table';
  @override
  VerificationContext validateIntegrity(
      Insertable<WorkEntriesTableData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  WorkEntriesTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return WorkEntriesTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      userId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}user_id'])!,
  ...
  @override
  $WorkEntriesTableTable createAlias(String alias) {
    return $WorkEntriesTableTable(attachedDatabase, alias);
  }
}

class WorkEntriesTableData extends DataClass
    implements Insertable<WorkEntriesTableData> {
  final String id;
  final String userId;
  final DateTime date;
  ...
  WorkEntriesTableCompanion toCompanion(bool nullToAbsent) {
    return WorkEntriesTableCompanion(
      id: Value(id),
      userId: Value(userId),
      date: Value(date),
  ...
  factory WorkEntriesTableData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return WorkEntriesTableData(
      id: serializer.fromJson<String>(json['id']),
  ...
  WorkEntriesTableData copyWithCompanion(WorkEntriesTableCompanion data) {
    return WorkEntriesTableData(
      id: data.id.present ? data.id.value : this.id,
      userId: data.userId.present ? data.userId.value : this.userId,
  ...
  @override
  String toString() {
    return (StringBuffer('WorkEntriesTableData(')
          ..write('id: $id, ')
          ..write('userId: $userId, ')
          ..write('date: $date, ')
  ...
  @override
  int get hashCode => Object.hash(id, userId, date, startTime, endTime,
      breakMinutes, note, createdAt, updatedAt, isDeleted, isSynced);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is WorkEntriesTableData &&
          other.id == this.id &&
          other.userId == this.userId &&
...
class WorkEntriesTableCompanion extends UpdateCompanion<WorkEntriesTableData> {
  final Value<String> id;
  final Value<String> userId;
  ...
  final Value<bool> isSynced;
  final Value<int> rowid;
  const WorkEntriesTableCompanion({
    this.id = const Value.absent(),
    this.userId = const Value.absent(),
  ...
  WorkEntriesTableCompanion.insert({
    required String id,
    required String userId,
    ...
    this.rowid = const Value.absent(),
        ...
        createdAt = Value(createdAt),
        updatedAt = Value(updatedAt);
  static Insertable<WorkEntriesTableData> custom({
    Expression<String>? id,
    Expression<String>? userId,
  ...
  WorkEntriesTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? userId,
      Value<DateTime>? date,
  ...
  @override
  String toString() {
    return (StringBuffer('WorkEntriesTableCompanion(')
          ..write('id: $id, ')
          ..write('userId: $userId, ')
          ..write('date: $date, ')
          ..write('startTime: $startTime, ')
...
class $LearningEntriesTableTable extends LearningEntriesTable
    with TableInfo<$LearningEntriesTableTable, LearningEntriesTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $LearningEntriesTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'learning_entries_table';
  @override
  VerificationContext validateIntegrity(
      Insertable<LearningEntriesTableData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  LearningEntriesTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return LearningEntriesTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      userId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}user_id'])!,
  ...
  @override
  $LearningEntriesTableTable createAlias(String alias) {
    return $LearningEntriesTableTable(attachedDatabase, alias);
  }
}

class LearningEntriesTableData extends DataClass
    implements Insertable<LearningEntriesTableData> {
  final String id;
  final String userId;
  final DateTime date;
  final DateTime startTime;
  ...
  final bool isDeleted;
  final bool isSynced;
  const LearningEntriesTableData(
      {required this.id,
      required this.userId,
      required this.date,
      required this.startTime,
  ...
  LearningEntriesTableCompanion toCompanion(bool nullToAbsent) {
    return LearningEntriesTableCompanion(
      id: Value(id),
      userId: Value(userId),
      date: Value(date),
      startTime: Value(startTime),
  ...
  factory LearningEntriesTableData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return LearningEntriesTableData(
      id: serializer.fromJson<String>(json['id']),
  ...
  LearningEntriesTableData copyWith(
          {String? id,
          String? userId,
          DateTime? date,
          DateTime? startTime,
  ...
  LearningEntriesTableData copyWithCompanion(
      LearningEntriesTableCompanion data) {
    return LearningEntriesTableData(
      id: data.id.present ? data.id.value : this.id,
      userId: data.userId.present ? data.userId.value : this.userId,
      date: data.date.present ? data.date.value : this.date,
  ...
  @override
  String toString() {
    return (StringBuffer('LearningEntriesTableData(')
          ..write('id: $id, ')
          ..write('userId: $userId, ')
          ..write('date: $date, ')
          ..write('startTime: $startTime, ')
  ...
  @override
  int get hashCode => Object.hash(id, userId, date, startTime, endTime,
      breakMinutes, topic, note, createdAt, updatedAt, isDeleted, isSynced);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is LearningEntriesTableData &&
          other.id == this.id &&
          other.userId == this.userId &&
          other.date == this.date &&
          other.startTime == this.startTime &&
...
class LearningEntriesTableCompanion
    extends UpdateCompanion<LearningEntriesTableData> {
  final Value<String> id;
  final Value<String> userId;
  final Value<DateTime> date;
  final Value<DateTime> startTime;
  ...
  final Value<bool> isSynced;
  final Value<int> rowid;
  const LearningEntriesTableCompanion({
    this.id = const Value.absent(),
    this.userId = const Value.absent(),
    this.date = const Value.absent(),
    this.startTime = const Value.absent(),
  ...
  LearningEntriesTableCompanion.insert({
    required String id,
    required String userId,
    required DateTime date,
    required DateTime startTime,
    ...
    this.rowid = const Value.absent(),
        ...
        createdAt = Value(createdAt),
        updatedAt = Value(updatedAt);
  static Insertable<LearningEntriesTableData> custom({
    Expression<String>? id,
    Expression<String>? userId,
    Expression<DateTime>? date,
    Expression<DateTime>? startTime,
  ...
  LearningEntriesTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? userId,
      Value<DateTime>? date,
      Value<DateTime>? startTime,
  ...
  @override
  String toString() {
    return (StringBuffer('LearningEntriesTableCompanion(')
          ..write('id: $id, ')
          ..write('userId: $userId, ')
          ..write('date: $date, ')
          ..write('startTime: $startTime, ')
...
abstract class _$LocalDatabase extends GeneratedDatabase {
  ...
  late final $WorkEntriesTableTable workEntriesTable =
      $WorkEntriesTableTable(this);
  late final $LearningEntriesTableTable learningEntriesTable =
      $LearningEntriesTableTable(this);
  @override
...
class $$CalendarEventsTableTableFilterComposer
    extends Composer<_$LocalDatabase, $CalendarEventsTableTable> {
...
class $$CalendarEventsTableTableTableManager extends RootTableManager<
    ...
    (
      CalendarEventsTableData,
      BaseReferences<_$LocalDatabase, $CalendarEventsTableTable,
          CalendarEventsTableData>
    ),
    CalendarEventsTableData,
    PrefetchHooks Function()> {
  $$CalendarEventsTableTableTableManager(
      _$LocalDatabase db, $CalendarEventsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
typedef $$CalendarEventsTableTableProcessedTableManager = ProcessedTableManager<
    ...
    CalendarEventsTableData,
    PrefetchHooks Function()>;
typedef $$WorkEntriesTableTableCreateCompanionBuilder
    = WorkEntriesTableCompanion Function({
  required String id,
  required String userId,
  required DateTime date,
  required DateTime startTime,
...
typedef $$WorkEntriesTableTableUpdateCompanionBuilder
    = WorkEntriesTableCompanion Function({
  Value<String> id,
  Value<String> userId,
  Value<DateTime> date,
...
class $$WorkEntriesTableTableFilterComposer
    extends Composer<_$LocalDatabase, $WorkEntriesTableTable> {
  $$WorkEntriesTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$WorkEntriesTableTableOrderingComposer
    extends Composer<_$LocalDatabase, $WorkEntriesTableTable> {
  $$WorkEntriesTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$WorkEntriesTableTableAnnotationComposer
    extends Composer<_$LocalDatabase, $WorkEntriesTableTable> {
  $$WorkEntriesTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$WorkEntriesTableTableTableManager extends RootTableManager<
    _$LocalDatabase,
    $WorkEntriesTableTable,
    WorkEntriesTableData,
    $$WorkEntriesTableTableFilterComposer,
    $$WorkEntriesTableTableOrderingComposer,
    $$WorkEntriesTableTableAnnotationComposer,
    $$WorkEntriesTableTableCreateCompanionBuilder,
    $$WorkEntriesTableTableUpdateCompanionBuilder,
    (
      WorkEntriesTableData,
      BaseReferences<_$LocalDatabase, $WorkEntriesTableTable,
          WorkEntriesTableData>
    ),
    WorkEntriesTableData,
    PrefetchHooks Function()> {
  $$WorkEntriesTableTableTableManager(
      _$LocalDatabase db, $WorkEntriesTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$WorkEntriesTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$WorkEntriesTableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$WorkEntriesTableTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> id = const Value.absent(),
            Value<String> userId = const Value.absent(),
...
typedef $$WorkEntriesTableTableProcessedTableManager = ProcessedTableManager<
    _$LocalDatabase,
    $WorkEntriesTableTable,
    WorkEntriesTableData,
    $$WorkEntriesTableTableFilterComposer,
    ...
    WorkEntriesTableData,
    PrefetchHooks Function()>;
typedef $$LearningEntriesTableTableCreateCompanionBuilder
    = LearningEntriesTableCompanion Function({
  required String id,
  required String userId,
  required DateTime date,
  required DateTime startTime,
...
typedef $$LearningEntriesTableTableUpdateCompanionBuilder
    = LearningEntriesTableCompanion Function({
  Value<String> id,
  Value<String> userId,
  Value<DateTime> date,
...
class $$LearningEntriesTableTableFilterComposer
    extends Composer<_$LocalDatabase, $LearningEntriesTableTable> {
  $$LearningEntriesTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LearningEntriesTableTableOrderingComposer
    extends Composer<_$LocalDatabase, $LearningEntriesTableTable> {
  $$LearningEntriesTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LearningEntriesTableTableAnnotationComposer
    extends Composer<_$LocalDatabase, $LearningEntriesTableTable> {
  $$LearningEntriesTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LearningEntriesTableTableTableManager extends RootTableManager<
    _$LocalDatabase,
    $LearningEntriesTableTable,
    LearningEntriesTableData,
    $$LearningEntriesTableTableFilterComposer,
    $$LearningEntriesTableTableOrderingComposer,
    $$LearningEntriesTableTableAnnotationComposer,
    $$LearningEntriesTableTableCreateCompanionBuilder,
    $$LearningEntriesTableTableUpdateCompanionBuilder,
    (
      LearningEntriesTableData,
      BaseReferences<_$LocalDatabase, $LearningEntriesTableTable,
          LearningEntriesTableData>
    ),
    LearningEntriesTableData,
    PrefetchHooks Function()> {
  $$LearningEntriesTableTableTableManager(
      _$LocalDatabase db, $LearningEntriesTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$LearningEntriesTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$LearningEntriesTableTableOrderingComposer(
                  $db: db, $table: table),
          createComputedFieldComposer: () =>
...
typedef $$LearningEntriesTableTableProcessedTableManager
...
class $LocalDatabaseManager {
  ...
  $$WorkEntriesTableTableTableManager get workEntriesTable =>
      $$WorkEntriesTableTableTableManager(_db, _db.workEntriesTable);
  $$LearningEntriesTableTableTableManager get learningEntriesTable =>
      $$LearningEntriesTableTableTableManager(_db, _db.learningEntriesTable);
}
